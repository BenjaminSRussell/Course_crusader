...
@register_scraper
class CarnegieMellonScraper(BaseCourseScraper):
    name = "carnegie_mellon"
    university = "Carnegie Mellon University"
    start_urls = ['https://httpbin.org/html']

    custom_settings = {
        'FEEDS': {
            'carnegie_mellon_courses.jsonl': {
                'format': 'jsonlines',
                'encoding': 'utf-8',
                'overwrite': True,
            },
    ...
    def parse(self, response):
        ...
        sample_courses = [
            ("INTRO 101", "Introduction to University", "Foundational course", 3),
